...
public class CdTCopa : MonoBehaviour {
	...
	public float MeshBlend07 = 0.0F;
	public float MeshBlend08 = 0.0F;
	public float MeshBlend09 = 0.0F;
	public float MeshBlend10 = 0.0F;
	public float MeshBlend11 = 0.0F;
	public float MeshBlend12 = 0.0F;
	...
	void OnGUI() {
		MeshBlend01 = GUI.HorizontalSlider(new Rect(20,60, 100, 20), MeshBlend01, 0.0f, 10.0F);
		MeshBlend02 = GUI.HorizontalSlider(new Rect(20,80, 100, 20), MeshBlend02, 0.0F, 10.0F);
		MeshBlend03 = GUI.HorizontalSlider(new Rect(20,100, 100, 20), MeshBlend03, 0.0F, 10.0F);
		MeshBlend04 = GUI.HorizontalSlider(new Rect(20,120, 100, 20), MeshBlend04, 0.0F, 10.0F);
		MeshBlend05 = GUI.HorizontalSlider(new Rect(20,140, 100, 20), MeshBlend05, 0.0F, 10.0F);
		MeshBlend06 = GUI.HorizontalSlider(new Rect(20,160, 100, 20), MeshBlend06, 0.0F, 10.0F);
		MeshBlend07 = GUI.HorizontalSlider(new Rect(20,180, 100, 20), MeshBlend07, 0.0F, 10.0F);
		MeshBlend08 = GUI.HorizontalSlider(new Rect(20,200, 100, 20), MeshBlend08, 0.0F, 10.0F);
		MeshBlend09 = GUI.HorizontalSlider(new Rect(20,220, 100, 20), MeshBlend09, 0.0F, 10.0F);
		MeshBlend10 = GUI.HorizontalSlider(new Rect(20,240, 100, 20), MeshBlend10, 0.0F, 10.0F);
		MeshBlend11 = GUI.HorizontalSlider(new Rect(20,260, 100, 20), MeshBlend11, 0.0F, 10.0F);
		//MeshBlend12 = GUI.HorizontalSlider(new Rect(20,240, 100, 20), MeshBlend12, 0.0F, 10.0F);
		uvXpos = GUI.HorizontalSlider(new Rect(15,280, 50, 20), uvXpos, 0.01F, 1.0F);
		uvYpos = GUI.HorizontalSlider(new Rect(75,280, 50, 20), uvYpos, 0.01F, 1.0F);
	...
	void Update () {
		...
		if(MeshBlend01 < (tronco.GetComponent<CdTTronco> ().MeshBlend01)){
			MeshBlend01 = (tronco.GetComponent<CdTTronco> ().MeshBlend01);
		};

		MeshBlend12 = (tronco.GetComponent<CdTTronco> ().MeshBlend03);
